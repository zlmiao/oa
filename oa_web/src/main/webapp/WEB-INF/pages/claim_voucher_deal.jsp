...
<%@page import="com.imooc.oa.global.Contant" %>                     <%--状态信息放在常量类里的，所以先引包--%>
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td>
                                <c:if test="${cv.status==Contant.CLAIMVOUCHER_CREATED || cv.status==Contant.CLAIMVOUCHER_BACK}">     <%--判断状态，调用常量类--%>
